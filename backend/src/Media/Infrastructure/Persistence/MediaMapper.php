...
{
    /**
     * @param array{id: string, owner_id: string, storage_key: string, original_filename: string, thumbnail_key: string|null,
    ...
    public function fromRow(array $row): MediaObject
    {
        return MediaObject::reconstitute(
            ...
            OriginalFilename::fromString($row['original_filename']),
